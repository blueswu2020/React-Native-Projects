...
export default class EmploymentList extends Component {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.searchContainer}>
                    ...
                    <TouchableOpacity
                        onPress={this.gotoEmploymentAdd}
                    >
    ...
    onGetEmployments = () => {
        ...
        storage.load({
            ...
            // 如果找到数据，则在then方法中返回
            fetch('http://192.168.1.3:3000/employments/' + ret ,{  //获取该管理员管理的用户列表
                method: 'GET'
            }).then((response) => {
    ...
    //跳转到新增活动界面
    gotoEmploymentAdd = () => {
        this.props.navigation.navigate('EmploymentAdd',{
