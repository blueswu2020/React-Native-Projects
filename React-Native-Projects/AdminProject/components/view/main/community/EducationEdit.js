...
export default class EducationEdit extends Component {
    ...
    UNSAFE_componentWillMount() {
        ...
        this.setState({
            ...
            maxNumber: education.maxNumber,
            enrollNumber: 0, //修改活动之后将报名人数清零
            attention: education.attention,
    ...
    onConfirmHandler = () => {
        if (
            this.state.title === this.state.education.title
            && this.state.context === this.state.education.context
            && this.state.location === this.state.education.location
            && this.state.startTime === this.state.education.startTime
            && this.state.endTime === this.state.education.endTime
            && this.state.maxNumber === this.state.education.maxNumber
            && this.state.attention === this.state.education.attention
        ){
            Alert.alert('提示：','未修改任何内容')
        }else{
            this.onUpdateEducation();
            this.turnToEducationDetail();
        }
    }
